...
import com.loanaalbisser.philipshueAlarm.BridgeControlApi
import com.loanaalbisser.philipshueAlarm.BridgeLightRequestBody
import com.loanaalbisser.philipshueAlarm.BridgeTokenRequestBody
...
class BridgeController(bridgeIp: String) : IBridgeController {
    ...
    private val bridgeControlApi = Retrofit.Builder()
    .baseUrl(baseUrl)
    ...
    @Throws(LinkButtonNotPressedException::class)
...
class LinkButtonNotPressedException :
    Exception("Click the link button to connect")
